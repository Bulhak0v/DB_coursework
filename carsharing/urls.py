...
urlpatterns = [
    ...
    path('statistics/additional_services', views.additional_services_statistics, name='additional_services_statistics'),
    path('statistics/insurance_usage_ratio', views.insurance_usage_ratio, name='insurance_usage_ratio'),
    ...
    path('additional_services/', views.additional_services_list, name='additional_services'),
    path('additional_services/add/', views.additional_service_add, name='additional_service_add'),
    path('additional_services/edit/<int:service_id>/', views.additional_service_edit,
         name='additional_service_edit'),
    path('additional_services/delete/<int:service_id>/', views.additional_service_delete,
         name='additional_service_delete'),
    ...
    path('rate-booking/<int:pk>/', views.rate_booking, name='rate_booking'),
]
